...
public class LoggingIn extends Constants {
    ...
    public void login() {
        ...
        //click on the search button after typing "Mohit"
        accountsPage.searchEditField.sendKeys(Keys.ENTER);

        //this shows the list and we should identify the Mohit element to click
